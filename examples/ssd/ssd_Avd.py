...
class SSD:
    ...
    def run_main(self, args, data_dir):
        ...
        job_name = '%d' % idx
        model_name = "VGG_Avd_{}".format(job_name)

        # Directory which stores the model .prototxt file.
        save_dir = "models/VGGNet/Avd/{}".format(job_name)
        # Directory which stores the snapshot of models.
        snapshot_dir = "models/VGGNet/Avd/{}".format(job_name)
        # Directory which stores the job script and log file.
        job_dir = "jobs/VGGNet/Avd/{}".format(job_name)
        # Directory which stores the detection results.
        output_result_dir = "data/Avd/results/{}/Main".format(job_name)
